declare module '@kitten-team/draggable/lib/draggable.bundle.legacy' {
  export * from '@kitten-team/draggable';
}

declare module '@kitten-team/draggable/lib/es5/draggable.bundle' {
  export * from '@kitten-team/draggable';
}

declare module '@kitten-team/draggable/lib/es5/draggable.bundle.legacy' {
  export * from '@kitten-team/draggable';
}

declare module '@kitten-team/draggable' {
